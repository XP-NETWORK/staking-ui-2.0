      ...
      <div className="navmobile">
        ...
        <div className="linksNavMob">
          ...
          >
            ...
            <label className="gitLabel">
                <img src={active}/>
                Latest Jan 17,2022</label>
          </a>{" "}
          <span />
        ...
        <a href="https://xp.network/community/" target="_blank" rel="noreferrer"
          className="titleNav"
        ...
        <div className="navMediaWrapperMob">
          ...
          <a href="https://t.me/xp_network" target="_blank" rel="noreferrer">
